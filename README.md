# Yau Tian Donaldson — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/yau-tian-donaldson-canonical-lane-mathlib.git
cd yau-tian-donaldson-canonical-lane-mathlib
lake exe
lake build
```
